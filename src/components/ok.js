...
import vueIcon from "@iconify/icons-logos/microsoft-azure";
...
class About extends Component {
  render() {
    ...
    const resumeLink = this.props.resumeBasicInfo.resume_link || '#';
              ...
              <div className="col-md-10">
                <div className="card">
                  ...
                  >
                    ...
                    <br />
                    <br />
                    <div dangerouslySetInnerHTML={{ __html: about.replace('Check out my resume', `<a href="${resumeLink}" target="_blank">Check out my resume</a>`) }} />
                  </div>
                </div>
              </div>
            </div>
